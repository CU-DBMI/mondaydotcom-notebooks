...
dagger.#Plan & {
	...
	client: {
		filesystem: {
			...
			"./mondaydotcom-notebooks": write: contents: actions.clean.black.export.directories."/workdir/mondaydotcom-notebooks"
	...
	actions: {
		...
		clean: {
			...
			remove_jupyter_output: docker.#Run & {
				...
				command: {
					name: "find"
					args: ["/workdir/mondaydotcom-notebooks", "-name", "*.ipynb",
			...
			isort: docker.#Run & {
				...
				command: {
					name: "poetry"
					args: ["run", "nbqa", "isort", "mondaydotcom-notebooks/"]
				}
			}
			...
			black: docker.#Run & {
				...
				command: {
					name: "poetry"
					args: ["run", "black", "mondaydotcom-notebooks/"]
				}
				export: {
					directories: {
						"/workdir/mondaydotcom-notebooks": _
					}
				}
			}
		...
		lint: {
			...
			mypy: {
				...
				copy: docker.#Run & {
					...
					command: {
						name: "cp"
						args: ["-r", "/workdir/mondaydotcom-notebooks/", "/workdir/mondaydotcom_notebooks/"]
					}
				}
				// actual mypy check
				run: docker.#Run & {
					...
					command: {
						name: "poetry"
						args: ["run", "nbqa", "mypy", "mondaydotcom_notebooks/", "--ignore-missing-imports"]
					}
				}
			}
			...
			isort: docker.#Run & {
				...
				command: {
					name: "poetry"
					args: ["run", "nbqa", "isort", "mondaydotcom-notebooks/", "--check", "--diff"]
				}
			}
			...
			black: docker.#Run & {
				...
				command: {
					name: "poetry"
					args: ["run", "nbqa", "black", "mondaydotcom-notebooks/", "--check"]
				}
			}
			// pylint checks
			pylint: docker.#Run & {
				...
				command: {
					name: "poetry"
					args: ["run", "nbqa", "pylint", "mondaydotcom-notebooks/"]
				}
			}
			...
			bandit: docker.#Run & {
				...
				command: {
					name: "poetry"
					args: ["run", "nbqa", "bandit", "mondaydotcom-notebooks/", "-r"]
				}
			}
		}
	}
